...
class _TrackingScreenState extends State<TrackingScreen> {
    ...
    if (_filterStatus != 'All') {
      deliveries = deliveries.where((d) {
        switch (_filterStatus) {
          case 'New':
            return d.hasNotStarted && !d.isCanceled;
          case 'In Progress':
            return d.hasStarted && d.isNotDelivered;
          case 'Completed':
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(() {
        ...
        return isDesktop
            ? _buildDesktop(deliveries)
            : _buildMobile(deliveries);
      }),
    );
  }
  ...
  Widget _buildSearchBar() {
    return Padding(
      ...
      child: Container(
        ...
        child: Row(
          children: [
            AppIcon(HugeIcons.strokeRoundedSearch02,
            ...
            Expanded(
              child: TextField(
                ...
                decoration: InputDecoration(
                  ...
                  hintStyle: TextStyle(
                      fontSize: 13, color: AppColors.lightTextColor),
        ...
        children: _filters.map((f) {
          ...
          return GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                color: isSelected
                    ? (f == 'All' ? AppColors.primaryColor : chipColor)
              ...
              child: AppText.medium(f,
                  fontSize: 12,
                  color:
                      isSelected ? Colors.white : AppColors.lightTextColor),
            ),
          );
        }).toList(),
      ),
  ...
  Widget _buildStats() {
    return Obx(() {
      ...
      final ongoing =
          all.where((d) => d.hasStarted && d.isNotDelivered).length;
      final newTrips =
          all.where((d) => d.hasNotStarted && !d.isCanceled).length;
      ...
      return Container(
        ...
        child: Row(
          children: [
            _StatChip(
                label: 'New', value: newTrips, color: AppColors.yellow),
            _Divider(),
            _StatChip(
                label: 'Active', value: ongoing, color: AppColors.accentColor),
            _Divider(),
  ...
  Widget _buildTripList(List<Delivery> deliveries) {
    if (deliveries.isEmpty) {
      return Center(
        child: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            AppIcon(HugeIcons.strokeRoundedRoute03,
                size: 48, color: AppColors.lightTextColor),
    ...
    return ListView.builder(
      ...
      itemBuilder: (_, i) => _TripCard(
        ...
        onTap: () {
          setState(() => _selectedDelivery = deliveries[i]);
  ...
  Widget _buildMap() {
    ...
    final pickupLoc = _selectedDelivery != null
        ? _findLocation(_selectedDelivery!.pickup ?? '')
        : null;
    final stopLoc =
        _selectedDelivery != null && _selectedDelivery!.stops.isNotEmpty
            ? _findLocation(_selectedDelivery!.stops.last)
            : null;
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    AppText.medium('Select a trip to view route',
                        fontSize: 13),
                    AppText.thin('Tap any trip card on the left',
          ...
          child: Column(
            children: [
              ...
              _MapBtn(
                  ...
                  onTap: () => _mapController.move(_defaultCenter, 7.0)),
            ],
          ),
        ),
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    height: 10,
                    decoration: BoxDecoration(
                      color: _statusColor(_selectedDelivery!),
                      shape: BoxShape.circle,
                    ),
                  ),
                  const SizedBox(width: 8),
                  Expanded(
                    child: Column(
                      ...
                      mainAxisSize: MainAxisSize.min,
                      children: [
                        AppText.bold('#${_selectedDelivery!.waybill}',
                            fontSize: 12),
                        AppText.thin(
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        AppText.medium('Driver GPS',
                            fontSize: 10, color: AppColors.accentColor),
                      ],
                    ),
                  ),
                  const SizedBox(width: 8),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (delivery.commodityType?.isNotEmpty ?? false)
                          AppText.thin(delivery.commodityType!,
                              fontSize: 10,
                              color: AppColors.lightTextColor,
                              maxlines: 1,
                              overflow: TextOverflow.ellipsis),
                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        AppText.thin(delivery.pickup ?? 'N/A',
                            fontSize: 12,
                            maxlines: 1,
                            overflow: TextOverflow.ellipsis),
              ...
              child: Row(
                children: [
                  AppIcon(HugeIcons.strokeRoundedContainerTruck01,
                      size: 13, color: AppColors.lightTextColor),
                  const SizedBox(width: 4),
                  AppText.thin(delivery.truckno ?? 'N/A',
                      fontSize: 11, color: AppColors.lightTextColor),
                  const SizedBox(width: 12),
                  AppIcon(HugeIcons.strokeRoundedUser,
                      size: 13, color: AppColors.lightTextColor),
                  const SizedBox(width: 4),
                  Expanded(
                    child: AppText.thin(delivery.driver ?? 'N/A',
                        fontSize: 11,
                        color: AppColors.lightTextColor,
                        maxlines: 1,
                        overflow: TextOverflow.ellipsis),
...
class _Divider extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
        width: 1, height: 30, color: AppColors.borderColor);
  }
}
