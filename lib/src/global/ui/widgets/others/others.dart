...
//   const FavouriteBtn(this.id, {super.key});
//   final String id;
...
//         });
//         if (isFav) {
//           await controller.profileRepo.appService.addToFavs(widget.id);
//         } else {
//           await controller.profileRepo.appService.removeFromFavs(widget.id);
//           controller.favoritePatient
//               .removeWhere((test) => test.id == widget.id);
//         }
//         Ui.showInfo("Card ${isFav ? "added to" : "removed from"} favourites");
//       },
//       child: CircleAvatar(
//         backgroundColor:
//             isFav ? AppColors.primaryColor : AppColors.textFieldColor,
//         radius: 16,
//         child: Icon(
//           Icons.favorite_border_rounded,
//           color: isFav ? AppColors.white : AppColors.textColor,
//         ),
//       ),
//     );
//   }
...
class PageIndicator extends StatefulWidget {
  ...
  const PageIndicator(
    ...
    this.inactiveColor = const Color(0xFFC2C2C2),
    Key? key,
  }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return RefreshIndicator(
      ...
      child: SingleChildScrollView(
        ...
        controller: scont,
        child: Column(
          children: [widget.child, if (loading) LoadingIndicator(padding: 24)],
        ),
      ),
    );
  }
